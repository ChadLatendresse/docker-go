const htmx = function () {
    ...
    const n = {
        ...
        getClosestMatch: N,
        getExpressionVars: bn,
        getHeaders: ln,
        getInputValues: nn,
        getInternalData: ie,
        getSwapSpecification: an,
        getTriggerSpecs: ot,
        getTarget: ve,
        makeFragment: k,
        mergeObjects: ue,
    ...
    function A(e, t, n) {
        ...
        if (e !== t && o && (o === "*" || o.split(" ").indexOf(n) >= 0)) {
            return "unset"
        } else {
            return r
        }
    ...
    function i(e, t) {
        ...
        const r = n.parseFromString(e, "text/html");
        let o = r.body;
        while (t > 0) {
            t--;
            o = o.firstChild
    ...
    function k(e) {
        ...
        if (Q.config.useTemplateFragments && t) {
            const o = i("<body><template>" + r + "</template></body>", 0);
            return o.querySelector("template").content
        }
        switch (n) {
            case"thead":
            case"tbody":
            ...
            case"colgroup":
            case"caption":
                return i("<table>" + r + "</table>", 1);
            case"col":
                return i("<table><colgroup>" + r + "</colgroup></table>", 2);
            case"tr":
                return i("<table><tbody>" + r + "</tbody></table>", 2);
            case"td":
            case"th":
                return i("<table><tbody><tr>" + r + "</tr></tbody></table>", 3);
            case"script":
            case"style":
                return i("<div>" + r + "</div>", 1);
            default:
                return i(r, 0)
        }
    }
    ...
    function a(e, t, n) {
        if (t.indexOf("closest ") === 0) {
            return [h(e, o(t.substr(8)))]
        } else if (t.indexOf("find ") === 0) {
            return [v(e, o(t.substr(5)))]
        } else if (t === "next") {
            return [e.nextElementSibling]
        } else if (t.indexOf("next ") === 0) {
            return [W(e, o(t.substr(5)), !!n)]
        } else if (t === "previous") {
            return [e.previousElementSibling]
        } else if (t.indexOf("previous ") === 0) {
            return [de(e, o(t.substr(9)), !!n)]
        } else if (t === "document") {
            return [document]
        } else if (t === "window") {
            return [window]
            ...
            return L(e, !!n).querySelectorAll(o(t))
        }
    }

    var W = function (t, e, n) {
        const r = L(t, n).querySelectorAll(e);
    ...
    function ge(e, t, n) {
        if (M(t)) {
            ...
            return {target: g(e), event: t, listener: n}
        }
    }
    ...
    const ye = ne().createElement("output");
    ...
    function xe(e, t) {
        ...
        if (n) {
            if (n === "this") {
                ...
                const r = a(e, n);
                if (r.length === 0) {
                    S('The selector "' + n + '" on ' + t + " returned no matches!");
                    return [ye]
                } else {
                    return r
                }
    ...
    function Se(t, n) {
        se(t.attributes, function (e) {
            if (!n.hasAttribute(e.name) && we(e.name)) {
    ...
    function Ee(e, n, r) {
        ...
        if (t) {
            ...
            for (let t = 0; t < o.length; t++) {
                ...
                const s = i[1] || "true";
                const l = n.querySelector("#" + e);
                if (l) {
                    Re(s, l, r)
                }
            }
        }
        se(c(n, "[hx-swap-oob], [data-hx-swap-oob]"), function (e) {
    ...
    function qe(e) {
        se(c(e, "[hx-preserve], [data-hx-preserve]"), function (e) {
            const t = te(e, "id");
    ...
    function Be(e, t, n) {
        const r = n || re(e, "hx-select");
        if (r) {
            const o = ne().createDocumentFragment();
            se(t.querySelectorAll(r), function (e) {
                o.appendChild(e)
            });
            t = o
        }
    ...
    function st(e, t, n) {
        ...
        r.timeout = setTimeout(function () {
            if (le(e) && r.cancelled !== true) {
                if (!ft(n, e, kt("hx:poll:trigger", {triggerSpec: n, target: e}))) {
                    t(e)
                }
                st(e, t, n)
            }
    ...
    function Rt(e) {
        if (e.querySelectorAll) {
            ...
            const n = e.querySelectorAll(q + t + ", form, [type='submit']," + " [hx-ext], [data-hx-ext], [hx-trigger], [data-hx-trigger]");
            return n
        } else {
            return []
        }
    ...
    function Tt(e) {
        ...
        const n = g("#" + ee(t, "form"), t.getRootNode()) || h(t, "form");
        if (!n) {
            return
        }
        return ie(n)
    ...
    function Ut(t, e, n, r) {
        ...
        t = j(t);
        const o = b(localStorage.getItem("htmx-history-cache")) || [];
        ...
        const i = {url: t, content: e, title: n, scroll: r};
        fe(ne().body, "htmx:historyItemCreated", {item: i, cache: o});
        o.push(i);
        while (o.length > Q.config.historyCacheSize) {
            o.shift()
        }
        while (o.length > 0) {
            try {
                ...
                ae(ne().body, "htmx:historyCacheError", {cause: e, cache: o});
                o.shift()
            }
        }
    }
    ...
    function Ft(t) {
        ...
        t = j(t);
        const n = b(localStorage.getItem("htmx-history-cache")) || [];
        for (let e = 0; e < n.length; e++) {
            if (n[e].url === t) {
                return n[e]
            }
    ...
    function Vt() {
        const e = Dt();
        const t = C || location.pathname + location.search;
        let n;
        try {
        ...
        if (!n) {
            ...
            Ut(t, Bt(e), ne().title, window.scrollY)
        }
    ...
    function $t(i) {
        ...
        const s = {path: i, xhr: e};
        fe(ne().body, "htmx:historyCacheMiss", s);
        e.open("GET", i, true);
        ...
        e.onload = function () {
            if (this.status >= 200 && this.status < 400) {
                fe(ne().body, "htmx:historyCacheMissLoad", s);
                let e = k(this.response);
                ...
                zt(n.tasks);
                C = i;
                fe(ne().body, "htmx:historyRestore", {path: i, cacheMiss: true, serverResponse: this.response})
            } else {
                ae(ne().body, "htmx:historyCacheMissLoadError", s)
            }
        };
        e.send()
    }
    ...
    function un(t, e) {
        const n = re(e, "hx-params");
        if (n) {
            if (n === "none") {
                return {}
            } else if (n === "*") {
                return t
            } else if (n.indexOf("not ") === 0) {
                se(n.substr(4).split(","), function (e) {
                    e = e.trim();
                    delete t[e]
                });
                return t
    ...
    function an(e, t) {
        ...
        if (Q.config.scrollIntoViewOnBoost && ie(e).boosted && !cn(e)) {
            r.show = "top"
        }
        if (n) {
            const s = B(n);
            if (s.length > 0) {
                for (let e = 0; e < s.length; e++) {
                    ...
                    if (l.indexOf("swap:") === 0) {
                        ...
                        S("Unknown modifier in hx-swap: " + l)
                    }
                }
            }
        }
    ...
    function yn(e, t) {
        return mn(e, "hx-vars", true, t)
    }

    function xn(e, t) {
        return mn(e, "hx-vals", false, t)
    }
    ...
    function Sn(e, t, n) {
        ...
        if (n) {
            if (n instanceof Element || X(n, "String")) {
                return he(e, t, null, null, {targetOverride: g(n), returnPromise: true})
            } else {
                return he(e, t, g(n.source), n.event, {
                    handler: n.handler,
                    headers: n.headers,
                    values: n.values,
    ...
    function he(t, n, r, o, i, X) {
        ...
        const M = i.handler || qn;
        const D = i.select || null;
        if (!le(r)) {
            oe(s);
            return e
        }
        const u = i.targetOverride || ve(r);
        if (u == null || u == ye) {
        ...
        if (X === undefined) {
            ...
            const Z = {target: u, elt: r, path: n, verb: t, triggeringEvent: o, etc: i, issueRequest: J, question: f};
            if (fe(r, "htmx:confirm", Z) === false) {
                oe(s);
                return e
            }
        }
        ...
        const F = re(r, "hx-prompt");
        if (F) {
            var y = prompt(F);
            if (y === null || !fe(r, "htmx:prompt", {prompt: y, target: u})) {
                oe(s);
                p();
                return e
            }
        ...
        if (Q.config.getCacheBusterParam && t === "get") {
            w["org.htmx.cache-buster"] = ee(u, "id") || "true"
        }
        if (n == null || n === "") {
            n = ne().location.href
        }
        const S = mn(r, "hx-request");
        ...
        if (C) {
            q = $;
            const Y = Object.keys(w).length !== 0;
            if (Y) {
                if (q.indexOf("?") < 0) {
                    q += "?"
                } else {
        ...
        if (!Rn(r, q, R)) {
            ae(r, "htmx:invalidPath", R);
            oe(l);
            return e
        }
        m.open(t.toUpperCase(), q, true);
        ...
        const T = {
            ...
            boosted: _,
            select: D,
            pathInfo: {requestPath: n, finalRequestPath: q, anchor: E}
        };
        m.onload = function () {
            try {
                const t = Cn(r);
                T.pathInfo.responsePath = wn(m);
                M(r, T);
                Kt(O, H);
                fe(r, "htmx:afterRequest", T);
                fe(r, "htmx:afterOnLoad", T);
                if (!le(r)) {
                    let e = null;
                    ...
                    if (e) {
                        fe(e, "htmx:afterRequest", T);
                        fe(e, "htmx:afterOnLoad", T)
                    }
                }
                oe(s);
                p()
            } catch (e) {
                ae(r, "htmx:onLoadError", ue({error: e}, T));
                throw e
            }
        };
        m.onerror = function () {
    ...
    function qn(c, a) {
        ...
        let h = a.target;
        const r = a.etc;
        const e = a.requestConfig;
        const d = a.select;
        if (!fe(c, "htmx:beforeOnLoad", a)) return;
        if (R(f, /HX-Trigger:/i)) {
            ze(f, "HX-Trigger", c)
        }
        if (R(f, /HX-Location:/i)) {
            Vt();
            let e = f.getResponseHeader("HX-Location");
            var g;
            if (e.indexOf("{") === 0) {
                g = b(e);
                e = g.path;
            ...
            Sn("GET", e, g).then(function () {
                jt(e)
            });
            return
        }
        const t = R(f, /HX-Refresh:/i) && f.getResponseHeader("HX-Refresh") === "true";
        ...
        if (R(f, /HX-Retarget:/i)) {
            if (f.getResponseHeader("HX-Retarget") === "this") {
                ...
                a.target = ce(c, f.getResponseHeader("HX-Retarget"))
            }
        }
        const m = En(c, a);
        const n = f.status >= 200 && f.status < 400 && f.status !== 204;
        let p = f.response;
        let o = f.status >= 400;
        let y = Q.config.ignoreTitle;
        const i = ue({shouldSwap: n, serverResponse: p, isError: o, ignoreTitle: y}, a);
        if (!fe(h, "htmx:beforeSwap", i)) return;
        h = i.target;
        p = i.serverResponse;
        o = i.isError;
        y = i.ignoreTitle;
        ...
        if (i.shouldSwap) {
            ...
            Mt(c, function (e) {
                p = e.transformResponse(p, f, c)
            });
            if (m.type) {
                Vt()
            }
            let e = r.swapOverride;
            if (R(f, /HX-Reswap:/i)) {
                e = f.getResponseHeader("HX-Reswap")
            }
            var g = an(c, e);
            if (g.hasOwnProperty("ignoreTitle")) {
                y = g.ignoreTitle
            }
            h.classList.add(Q.config.swappingClass);
            let l = null;
            let u = null;
            let t = function () {
                try {
                    ...
                    let e = {};
                    try {
                        e = {elt: n, start: n ? n.selectionStart : null, end: n ? n.selectionEnd : null}
                    } catch (e) {
                    }
                    let t;
                    if (d) {
                    ...
                    if (R(f, /HX-Reselect:/i)) {
                        t = f.getResponseHeader("HX-Reselect")
                    }
                    if (m.type) {
                        fe(ne().body, "htmx:beforeHistoryUpdate", ue({history: m}, a));
                        if (m.type === "push") {
                            jt(m.path);
                            fe(ne().body, "htmx:pushedIntoHistory", {path: m.path})
                        } else {
                            _t(m.path);
                            fe(ne().body, "htmx:replacedInHistory", {path: m.path})
                        }
                    }
                    const r = dn(h);
                    _e(g.swapStyle, h, c, p, r, t);
                    if (e.elt && !le(e.elt) && ee(e.elt, "id")) {
                        const i = document.getElementById(ee(e.elt, "id"));
                        const s = {preventScroll: g.focusScroll !== undefined ? !g.focusScroll : !Q.config.defaultFocusScroll};
                        if (i) {
                            if (e.start && i.setSelectionRange) {
                                try {
                                    i.setSelectionRange(e.start, e.end)
                                } catch (e) {
                                }
                            }
                            i.focus(s)
                    ...
                    se(r.elts, function (e) {
                        if (e.classList) {
                            e.classList.add(Q.config.settlingClass)
                        }
                        fe(e, "htmx:afterSwap", a)
                    });
                    if (R(f, /HX-Trigger-After-Swap:/i)) {
                        ...
                        ze(f, "HX-Trigger-After-Swap", e)
                    }
                    const o = function () {
                        se(r.tasks, function (e) {
                            e.call()
                        });
                        se(r.elts, function (e) {
                            if (e.classList) {
                            ...
                            fe(e, "htmx:afterSettle", a)
                        });
                        if (a.pathInfo.anchor) {
                            const e = ne().getElementById(a.pathInfo.anchor);
                            if (e) {
                        ...
                        if (R(f, /HX-Trigger-After-Settle:/i)) {
                            ...
                            ze(f, "HX-Trigger-After-Settle", e)
                        }
                        oe(l)
                    };
                    if (g.settleDelay > 0) {
                        setTimeout(o, g.settleDelay)
                    } else {
                        o()
                    }
                } catch (e) {
                    ae(c, "htmx:swapError", a);
                    oe(u);
                    throw e
                }
            };
            let n = Q.config.globalViewTransitions;
            if (g.hasOwnProperty("transition")) {
                n = g.transition
            }
            if (n && fe(c, "htmx:beforeTransition", a) && typeof Promise !== "undefined" && document.startViewTransition) {
                const s = new Promise(function (e, t) {
                    l = e;
                    u = t
                });
                const x = t;
            ...
            if (g.swapDelay > 0) {
                setTimeout(t, g.swapDelay)
            } else {
                t()
            }
        }
        if (o) {
            ae(c, "htmx:responseError", ue({error: "Response Status Error Code " + f.status + " from " + a.pathInfo.requestPath}, a))
        }
    }
    ...
    function An(e) {
        ...
        if (ne().readyState === "complete") {
            t()
        } else {
            ne().addEventListener("DOMContentLoaded", function () {
                t()
            });
            ne().addEventListener("readystatechange", function () {
                if (ne().readyState !== "complete") return;
                t()
            })
        }
    }
